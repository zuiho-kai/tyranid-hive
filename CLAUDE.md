...
<!-- ═══════════════════════════════════════════════════════════
  双轨说明（Phase 1 Hive Substrate，2026-04）
  [CONSTITUTION]  不可变免疫边界，永久生效，禁止删除
  [HEURISTIC]     当前保留生效，Phase 2 起逐步被 Episode 查询替代
  详见 docs/specs/phase1-hive-substrate.md § 3.1
═══════════════════════════════════════════════════════════ -->

## 思考模式

每次回复前必须先在 `<think>...</think>` 标签内进行详细推理分析，然后再给出实际回复。

## 语言

全中文输出：所有对话、文档、注释、commit message 一律使用中文。

## 🔐 安全硬规则（最高优先级）<!-- [CONSTITUTION] -->
